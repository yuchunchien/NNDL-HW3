...
class LeNetConvPoolLayer(object):
    ...
    def __init__(self, rng, input, filter_shape, image_shape, poolsize=(2, 2), activation=T.tanh, drop_p=1):
        """
        ...
        self.output = drop(activation(pooled_out + self.b.dimshuffle('x', 0, 'x', 'x')), drop_p)
